...
private:
    ...
    std::vector<int> Neighbors(point x_new, double radius);
    double Cost(int idx_node);
    int optimalNeighbor(std::vector<int> idx_neighbors, int idx_near, point x_new);
    void rewire(int idx_new, std::vector<int> idx_neighbors, int idx_optimal);
